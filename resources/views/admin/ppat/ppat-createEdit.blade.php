...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <br>
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="{{route('ppat_save')}}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="autocomplete-custom-append"  type="text" class="form-control col-md-7 col-xs-12" name="no_akta" value="{{$object->no_akta}}">
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-6">SSP</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" class="form-control col-md-7 col-xs-12" name="ssp" value="{{$object->ssp}}">
                </div>
            </div>
            
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Waktu SSP</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="control-group">
                        <div class="controls">
                            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                <input type="text" class="form-control has-feedback-left" id="datepicker_waktu_ssp" name="waktu_ssp">
                                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                <span id="inputSuccess2Status3" class="sr-only">(success)</span>
                            </div>
                        </div>
                ...
                <script>
                $('#datepicker_waktu_ssp').daterangepicker({
                    singleDatePicker: true,
                    singleClasses: "picker_3",
                    @if(!empty($object->id))
                    startDate: "{{$object->waktu->format('m/d/Y')}}"
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-6">BPHTB</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" class="form-control col-md-7 col-xs-12" name="bphtb" value="{{$object->bphtb}}">
                </div>
            </div>
            
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Waktu BPHTB</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="control-group">
                        <div class="controls">
                            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                <input type="text" class="form-control has-feedback-left" id="datepicker_waktu_bphtb" name="waktu_bphtb">
                                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                <span id="inputSuccess2Status3" class="sr-only">(success)</span>
                            </div>
                        </div>
                ...
                <script>
                $('#datepicker_waktu_bphtb').daterangepicker({
                    singleDatePicker: true,
                    singleClasses: "picker_3",
                    @if(!empty($object->id))
                    startDate: "{{$object->waktu->format('m/d/Y')}}"
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-6">HT</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="number" class="form-control col-md-7 col-xs-12" name="ht" value="{{$object->ht}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <a href="{{route('ppat_download',$object->lampiran)}}">

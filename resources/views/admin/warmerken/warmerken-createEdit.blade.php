...
<div class="x_panel">
    ...
    <div class="x_content">
        <br>
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="{{route('warmerken_save')}}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <a href="{{route('warmerken_download',$object->lampiran)}}">
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <a class="btn btn-primary" href="{{route('warmerken_list')}}">Cancel</a>
